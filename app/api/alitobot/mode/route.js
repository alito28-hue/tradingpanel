...
// its matcher) — no extra auth logic needed here. Hits the SAME worker as
// /api/bot-mode (one Railway service, STRATEGY_MODE picks the loop) but a
// different URL because runAlitobot.js keeps its own separate mode file
// (alitobot_mode_state.json) — see worker/runAlitobot.js's comment on why.
