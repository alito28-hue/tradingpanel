...
module.exports = {
  ...
  classifyRoiBand, getRegularBandBalas, initialState, totalBalasUsed, cargadorStatus,
  estimateLiquidationPrice, allocateBalas, balasToUsd, checkExitConditions, computeDailyRecarga,
};
